<?php 
    ...
    $id = (int)getInput('id');
    $productById = $db->fetchID('typeofproduct',$id); 
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if(empty($errors)){
            ...
            if($checkNameExist){
                ...
                $id_update = $db->updateDB('typeofproduct',$data,array('id'=>$id));
                if($id_update>0)
                {
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <?php 
                                            foreach($categories as $item){ ?>
                                                ...
                                                <option value="<?php echo $item['id'] ?>" 
                                                        <?php if ($item['id'] == $productById['id_category']) {
                                                            echo "selected";
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="inputEmail3" placeholder="Nhập tên" name='name' value="<?php echo $productById['name'] ?>">
